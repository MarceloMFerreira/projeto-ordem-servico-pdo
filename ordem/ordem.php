                ...
                <div class="row">
                    ...
                    <div class="col-md-4 card_button_title">
                        <?php if ($_SESSION['perfil'] == 1)
                            echo '<a title="Adicionar nova ordem" href="cad_ordem.php"><button type="button" class="btn btn-primary btn-sm card_button_title" data-toggle="modal" id=" "> <i class="fas fa-fw fa-clipboard-list">&nbsp;</i> Adicionar Ordem</button></a>';
                        ?>
                    </div>
                </div>
                    ...
                    <table class="table table-bordered" id="dataTable" width="100%" cellspacing="0">
                        ...
                        <tbody>
                            ...
                            if ($_SESSION['perfil'] == 1)
                                $ordem = listaOrdem($_GET['status']);
                            else if ($_SESSION['perfil'] == 2)
                                $ordem = listaOrdem($_GET['status'], $_SESSION['cod_usu']);
                            else if ($_SESSION['perfil'] == 3)
                                $ordem = listaOrdem($_GET['status'], null, $_SESSION['cod_usu']);
                                    ...
                                    <td class="text-center">
                                        <?php if (($dados['status'] == 1) or ($dados['status'] == 2)) : ?>
                                            <?php if ($_SESSION['perfil'] != 2)
                                                echo '<a title="Atualizar" href="editar_ordem.php?cod=' . $dados['cod'] . '" class="btn btn-sm btn-success"><i class="fas fa-edit">&nbsp;</i>Atualizar</a>';
                                            ?>
                                        <?php endif ?>
                                    </td>
                                    <td class="text-center">
                                        <?php if (($dados['status'] == 1) or ($dados['status'] == 3)) : ?>
                                            <?php if ($_SESSION['perfil'] == 1)
                                                echo '<a title="Excluir" href="javascript:void(0)" data-toggle="modal" data-target="#excluir-' . $dados["cod"] . '" class="btn btn-sm btn-danger"><i class="fas fa-trash-alt">&nbsp;</i>Excluir</a>';
                                    ...
                                    <div class="modal-dialog" role="document">
                                        <div class="modal-content">
                                            ...
                                            <div class="modal-footer">
                                                <a href="remove_ordem.php?cod=<?= $dados['cod']; ?>&status=<?= $dados['status']; ?>"><button class="btn btn-primary btn-user" type="button">Confirmar</button></a>
                                                <a href="ordem.php?status=<?= $dados['status']; ?>"><button class="btn btn-danger btn-user" type="button">Cancelar</button></a>
